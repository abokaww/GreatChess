    ...
    <div className="flex min-h-[320px] flex-col gap-4">
      <div className="glass flex-1 rounded-2xl p-4">
        ...
        {moveHistory.length === 0 ? (
          ...
          <ol className="max-h-40 space-y-1 overflow-y-auto text-sm font-mono">
      ...
      <div className="glass rounded-2xl p-4">
        ...
        {gameOver && !analysis && !panelMessage && !loading && (
          <Button
        ...
        {analysis && !loading && (
          <div className="space-y-2">
            ...
            <div className="max-h-[min(50vh,420px)] overflow-y-auto whitespace-pre-wrap text-sm leading-relaxed text-foreground">
              {analysis}
            </div>
          </div>
        )}
